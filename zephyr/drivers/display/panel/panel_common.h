...
#ifndef CONFIG_PANEL_ROTATION
#  define CONFIG_PANEL_ROTATION (0)
#elif CONFIG_PANEL_ROTATION != 0 && CONFIG_PANEL_ROTATION != 90 && \
      CONFIG_PANEL_ROTATION != 180 && CONFIG_PANEL_ROTATION != 270
#  error CONFIG_PANEL_ROTATION must be one of [0|90|180|270]
#endif
