...
/* anc coff address layout (in words) */
/* -----------------------------------------------------------------------------
 ...
 * 		owner. It is used to decide which anc image that request the current
 * 		page miss in mutiple anc image run environment. So far, only set on
...
/* image file type */
#define ANC_CODEC_LIB (0)
#define ANC_SOUND_EFFECT_LIB (1)

/* image file sub-type */
#define ANC_DECODER_MP3 (0)
#define ANC_DECODER_WMA (1)
#define ANC_DECODER_WAV (2)
#define ANC_DECODER_AAC (3)
#define ANC_DECODER_APE (4)
#define ANC_DECODER_FLAC (5)
#define ANC_DECODER_OGG (6)
#define ANC_DECODER_SBC (7)
#define ANC_DECODER_MSBC (8)

#define ANC_ENCODER_WAV (40)
#define ANC_ENCODER_MP3 (41)
#define ANC_ENCODER_SBC (42)

//ANC sound effect definition
#define ANC_SOUND_EFFECT_PEQ (0)
#define ANC_SOUND_EFFECT_SRS (1)
#define ANC_SOUND_EFFECT_ACT (2)
