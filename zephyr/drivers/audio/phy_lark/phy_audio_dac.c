 ...
 * DAC_DIGCTL
 */
#define DAC_DIGCTL_SMC_DONE_PD                                 BIT(30) /* DAC playback soft mute done pending */
#define DAC_DIGCTL_SMC_IRQ                                     BIT(29) /* soft-mute counter done IRQ enable */
#define DAC_DIGCTL_SDM_DITH_TH_SHIFT                           (26) /* DC reference threshold */
#define DAC_DIGCTL_SDM_DITH_TH_MASK                            (0x7 << DAC_DIGCTL_SDM_DITH_TH_SHIFT)
#define DAC_DIGCTL_SDM_DITH_TH(x)                              ((x) << DAC_DIGCTL_SDM_DITH_TH_SHIFT)
#define DAC_DIGCTL_SDM_DITH_MIX                                BIT(25) /* DC reference mix operations. 0: ADD; 1: SUB */
...
#define DAC_DIGCTL_DAF1M2DAEN                                  BIT(18) /* DAC FIFO1 MIX to PCMBUF */
#define DAC_DIGCTL_DAF0M2DAEN                                  BIT(17) /* DAC FIFO0 MIX to PCMBUF */
#define DAC_DIGCTL_DADCS                                       BIT(16) /* DAC DEBUG channel select */
#define DAC_DIGCTL_DADEN                                       BIT(15) /* DAC analog DEBUG enable */
#define DAC_DIGCTL_DDDEN                                       BIT(14) /* DAC digital DEBUG enable */
#define DAC_DIGCTL_AD2DA_CHSEL                                 BIT(13) /* 0: ADC0/1 MIX to DAC; 1: ADC2/3 MIX to DAC */
...
#define DAC_DIGCTL_DALRMIX                                     BIT(9) /* DAC L MIX R and only used in stereo mode */
#define DAC_DIGCTL_DACHNUM                                     BIT(8)
#define DAC_DIGCTL_INTFRS_SHIFT                                (6)
#define DAC_DIGCTL_INTFRS_MASK                                 (0x3 << DAC_DIGCTL_INTFRS_SHIFT)
#define DAC_DIGCTL_INTFRS3_SHIFT                               (5)
#define DAC_DIGCTL_INTFRS3                                     BIT(5) /* interpolation filter 3X rate select */
#define DAC_DIGCTL_OSRDA3                                      BIT(4) /* OSR 3X */
#define DAC_DIGCTL_OSRDA_SHIFT                                 (2) /* OSR */
...
#define DAC_FIFOCTL_FIFO0_VOL_SHIFT                            (8)
#define DAC_FIFOCTL_FIFO0_VOL_MASK                             (0xF << DAC_FIFOCTL_FIFO0_VOL_SHIFT)
#define DAC_FIFOCTL_FIFO0_VOL(x)                               ((x) << DAC_FIFOCTL_FIFO0_VOL_SHIFT)
 ...
 * DAC_STAT
 */
#define DAC_STAT_FIFO1_ER                                      BIT(24) /* FIFO1 ERROR */
#define DAC_STAT_DAF1EIP                                       BIT(23) /* FIFO1 half empty IRQ */
#define DAC_STAT_DAF1F                                         BIT(22) /* FIFO1 full flag */
#define DAC_STAT_DAF1S_SHIFT                                   (16) /* FIFO1 fill status */
#define DAC_STAT_DAF1S_MASK                                    (0x3F << DAC_STAT_DAF1S_SHIFT)
...
#define PCM_BUF_STAT_PCMBS_MASK                                (0xFFF << PCM_BUF_STAT_PCMBS_SHIFT) /* indicates the available samples to fill */
...
#define SDM_RESET_CTL_SDMRDS_R                                 BIT(2) /* 1: SDM detect R valid */
...
#define AUTO_MUTE_CTL_AMPD                                     BIT(2) /* auto mute detect pending */
 ...
 * FIFO1_CNT
 */
#define FIFO1_CNT_IP                                           BIT(18)
#define FIFO1_CNT_IE                                           BIT(17)
#define FIFO1_CNT_EN                                           BIT(16)
#define FIFO1_CNT_CNT_SHIFT                                    (0)
#define FIFO1_CNT_CNT_MASK                                     (0xFFFF << FIFO1_CNT_CNT_SHIFT)
 ...
 * DAC_ANACTL0
 */
#define DAC_ANACTL0_OVDTOUT                                    BIT(31) /* pa/vro over load state (readonly) */
#define DAC_ANACTL0_OVDTEN                                     BIT(28) /* pa/vro output over load detection enable */
#define DAC_ANACTL0_SEL_PLAN                                   BIT(27) /* 0: tradition struction; 1: high performance struction */
#define DAC_ANACTL0_SEL_CUR_SHIFT                              (25) /* DAC current set */
#define DAC_ANACTL0_SEL_CUR_MASK                               (0x3 << DAC_ANACTL0_SEL_CUR_SHIFT)
#define DAC_ANACTL0_SEL_CUR(x)                                 ((x) << DAC_ANACTL0_SEL_CUR_SHIFT)
#define DAC_ANACTL0_DIFF6dB                                    BIT(24) /* 1: DIFF mode gain reduce 6dB */
#define DAC_ANACTL0_PAVOL_SHIFT                                (21) /* pa volume */
#define DAC_ANACTL0_PAVOL_MASK                                 (0x7 << DAC_ANACTL0_PAVOL_SHIFT)
#define DAC_ANACTL0_PAVOL(x)                                   ((x) << DAC_ANACTL0_PAVOL_SHIFT)
#define DAC_ANACTL0_SW1RN                                      BIT(20) /* 1: LP PA output volume enable */
#define DAC_ANACTL0_SW1RP                                      BIT(19) /* 1: RP PA output volume enable */
#define DAC_ANACTL0_SW1LN                                      BIT(18) /* 1: LN PA output volume enable */
#define DAC_ANACTL0_SW1LP                                      BIT(17) /* 1: LP PA output volume enable */
#define DAC_ANACTL0_DFCEN                                      BIT(16) /* 1: enable PA DFC option */
#define DAC_ANACTL0_BUFM                                       BIT(15) /* 1: enable direct mode */
#define DAC_ANACTL0_DIFFM                                      BIT(14) /* 0: single mode; 1: diff mode */
#define DAC_ANACTL0_PARNOSEN                                   BIT(13) /* RN output stage enable */
#define DAC_ANACTL0_PARNEN                                     BIT(12) /* RN op enable */
#define DAC_ANACTL0_PARPOSEN                                   BIT(11) /* RP output stage enable (VRO) */
#define DAC_ANACTL0_PARPEN                                     BIT(10) /* RP op enable (VRO) */
#define DAC_ANACTL0_PALNOSEN                                   BIT(9) /* LN output stage enable */
#define DAC_ANACTL0_PALNEN                                     BIT(8) /* LN op enable */
#define DAC_ANACTL0_PALPOSEN                                   BIT(7) /* LP output stage enable */
#define DAC_ANACTL0_PALPEN                                     BIT(6) /* LP op enable */
#define DAC_ANACTL0_ZERODT                                     BIT(5) /* zero data enable */
#define DAC_ANACTL0_DAINVENR                                   BIT(4) /* R channel INV enable */
#define DAC_ANACTL0_DAINVENL                                   BIT(3) /* L channel INV enable */
#define DAC_ANACTL0_DAENR                                      BIT(2) /* R channel enable */
#define DAC_ANACTL0_DAENL                                      BIT(1) /* L channel enable */
#define DAC_ANACTL0_BIASEN                                     BIT(0) /* DAC + PA current bias enable */

/***************************************************************************************************
 * DAC_ANACTL1
 */
#define DAC_ANACTL1_ATP2RCENR                                  BIT(23) /* R channel antipop ramp data compensation */
#define DAC_ANACTL1_ATP2RCENL                                  BIT(22) /* L channel antipop ramp data compensation */
#define DAC_ANACTL1_SMCCKS_SHIFT                               (19) /* soft mute control clock selection */
#define DAC_ANACTL1_SMCCKS_MASK                                (0x7 << DAC_ANACTL1_SMCCKS_SHIFT)
#define DAC_ANACTL1_SMCCKS(x)                                  ((x) << DAC_ANACTL1_SMCCKS_SHIFT)
#define DAC_ANACTL1_DPBMR                                      BIT(18) /* DAC R playback mute enable */
#define DAC_ANACTL1_DPBMLN                                     BIT(17) /* DAC LN playback mute enable */
#define DAC_ANACTL1_DPBMLP                                     BIT(16) /* DAC LP playback mute enable */
#define DAC_ANACTL1_SMCEN                                      BIT(15) /* DAC soft mute control enable */
#define DAC_ANACTL1_ATPSW2RP                                   BIT(14) /* switch 2 for enable RP channel */
#define DAC_ANACTL1_ATPSW2LN                                   BIT(13) /* switch 2 for enable LN channel */
#define DAC_ANACTL1_ATPSW2LP                                   BIT(12) /* switch 2 for enable LP channel */
...
#define DAC_ANACTL1_ATPRC2EN_RP                                BIT(8) /* antipop ramp connect 2 enable for RP PA */
#define DAC_ANACTL1_ATPRC2EN_LN                                BIT(7) /* antipop ramp connect 2 enable for LN PA */
#define DAC_ANACTL1_ATPRC2EN_LP                                BIT(6) /* antipop ramp connect 2 enable for LP PA */
#define DAC_ANACTL1_ATPRCEN_RP                                 BIT(5) /* antipop ramp connect enable for RP PA */
#define DAC_ANACTL1_ATPRCEN_LN                                 BIT(4) /* antipop ramp connect enable for LN PA */
#define DAC_ANACTL1_ATPRCEN_LP                                 BIT(3) /* antipop ramp connect enable for LP PA */
...
#define DAC_ANACTL2_PA_LOAD_SEL                                BIT(2) /* 0: pa load with 16/32R load; 1: pa load with 10k load */
#define DAC_ANACTL2_EN_CURBIAS                                 BIT(1) /* 0: current bias always enable; 1: disable with SH_CLK for power saving */
 ...
 * ADC_REF_LDO_CTL
 */
#define ADC_REF_LDO_CTL_BASE                                    (0x4005c148)
 ...
 * ANC_MIX_CTL
 */
#define ANC_MIX_CTL_BASE                                        (0x4005c200)
#define ANC_MIX_CTL_PLAY_MIX_REN                                BIT(9) /* ANC play source mix to DAC right channel */
#define ANC_MIX_CTL_PLAY_MIX_LEN                                BIT(8) /* ANC play source mix to DAC left channel */

/***************************************************************************************************
 * ALL_REG_ACCESS_SEL
 */
#define ALL_REG_ACCESS_SEL_BASE                                 (0x4005c254)
#define ALL_REG_ACCESS_SEL_CPU_OR_DSP                           BIT(0) /* 0: ANC registers access by CPU; 1: ANC registers access by ANCDSP */
...
struct acts_audio_dac {
    ...
    volatile uint32_t fifo1_dat; /* DAC FIFO1 data */
    ...
    volatile uint32_t fifo1_cnt; /* DAC FIIO1 sample counter */
...
typedef enum {
    ...
    DAC_OSR_64X,
    DAC_OSR_128X,
    DAC_OSR_48X, /* DAC_OSR_16X * 3 */
    DAC_OSR_96X, /* DAC_OSR_32X * 3 */
    DAC_OSR_192X, /* DAC_OSR_64X * 3 */
    DAC_OSR_384X, /* DAC_OSR_128X * 3 */
} a_dac_osr_e;
...
static void dac_dump_register(struct device *dev)
{
    ...
    LOG_INF("        FIFO1_DAT: %08x", dac_reg->fifo1_dat);
    ...
    LOG_INF("        FIFO1_CNT: %08x", dac_reg->fifo1_cnt);
...
static void __dac_fifo_disable(struct device *dev, a_dac_fifo_e idx)
{
    ...
    if (DAC_FIFO_0 == idx) {
        ...
        /* disable DAC FIFO1 to access clock */
        sys_write32(sys_read32(CMU_DACCLK) & ~CMU_DACCLK_DACFIFO1CLKEN, CMU_DACCLK);
    }
}
                            ...
                            uint8_t fifo_vol, a_dac_fifo_e idx, bool fifo1_mix_en)
{
    ...
    if (DAC_FIFO_0 == idx) {
        ...
        reg &= 0xFFFF; /* clear all FIFO1 fields */
        if (FIFO_SEL_CPU == sel)
            reg |= DAC_FIFOCTL_DAF1EIE; /* enable irq */
        else if (FIFO_SEL_DMA == sel)
            reg |= DAC_FIFOCTL_DAF1EDE; /* enable drq */

        reg |= DAC_FIFOCTL_DAF1IS(sel);

        if (DMA_WIDTH_16BITS == wd)
            reg |= DAC_FIFOCTL_DACFIFO1_DMAWIDTH;

        reg |= DAC_FIFOCTL_DRQ1_LEVEL(drq_level);
        reg |= DAC_FIFOCTL_FIFO1_VOL(fifo_vol);

        reg |= DAC_FIFOCTL_DAF1RT;

        dac_reg->fifoctl = reg;

        /* DAC FIFO1 MIX to DAC enable */
        if (fifo1_mix_en)
...
static int __dac_fifo_update_src(struct device *dev, dac_fifosrc_setting_t *fifosrc)
{
	...
	if (DAC_FIFO_0 == idx) {
		...
		reg &= ~DAC_FIFOCTL_DAF1IS_MASK;
		reg |= DAC_FIFOCTL_DAF1IS(sel);

		if (sel == FIFO_SEL_DSP) {
			reg &= ~DAC_FIFOCTL_DAF1EIE; /* disable irq */
			reg &= ~DAC_FIFOCTL_DAF1EDE; /* disable drq */
		} else {
			if (FIFO_SEL_CPU == sel)
				reg |= DAC_FIFOCTL_DAF1EIE; /* enable irq */
			else if (FIFO_SEL_DMA == sel)
...
static void __wait_dac_fifo_empty(struct device *dev, a_dac_fifo_e idx)
{
    ...
    if (DAC_FIFO_0 == idx) {
        ...
        while (((dac_reg->stat & DAC_STAT_DAF1S_MASK) >> DAC_STAT_DAF1S_SHIFT)
                != DAC_FIFO_MAX_LEVEL) {
            ;
        }
    }
...
static bool __is_dac_fifo_working(struct device *dev, a_dac_fifo_e idx)
{
    ...
    if (DAC_FIFO_0 == idx) {
        ...
        if (dac_reg->fifoctl & DAC_FIFOCTL_DAF1RT)
            return true;
    }
...
static bool __is_dac_fifo_empty(struct device *dev, a_dac_fifo_e idx)
{
    ...
    if (DAC_FIFO_0 == idx) {
        ...
        /* if DAC FIFO1 MIX to PCMBUF */
        if ((dac_reg->digctl & DAC_DIGCTL_DAF1M2DAEN)
            && (DAC_PCMBUF_MAX_CNT == __get_pcmbuf_avail_length(dev))) {
            return true;
        } else {
            fifo_status = (dac_reg->stat & DAC_STAT_DAF1S_MASK) >> DAC_STAT_DAF1S_SHIFT;
            if (fifo_status >= (DAC_FIFO_MAX_LEVEL - 1))
                return true;
        }
    }
...
static bool __is_dac_fifo_all_free(struct device *dev, bool check_mix)
{
    ...
    if (check_mix) {
        ...
        if (__is_dac_fifo_working(dev, DAC_FIFO_1))
            return false;
    }
...
static bool __check_dac_fifo_error(struct device *dev, a_dac_fifo_e idx)
{
    ...
    if (DAC_FIFO_1 == idx) {
        if (dac_reg->stat & DAC_STAT_FIFO1_ER)
            return true;
    }
...
static void __dac_clear_fifo_error(struct device *dev, a_dac_fifo_e idx)
{
    ...
    if (DAC_FIFO_1 == idx) {
        if (dac_reg->stat & DAC_STAT_FIFO1_ER)
            dac_reg->stat |= DAC_STAT_FIFO1_ER;
    }
}
...
static void __dac_fifo_counter_enable(struct device *dev, a_dac_fifo_e idx)
{
    ...
    if (DAC_FIFO_0 == idx) {
        ...
        dac_reg->fifo1_cnt |= FIFO1_CNT_EN;
        dac_reg->fifo1_cnt |= FIFO1_CNT_IE;
        dac_reg->fifo1_cnt |= FIFO1_CNT_IP;
    }
}
...
static void __dac_fifo_counter_disable(struct device *dev, a_dac_fifo_e idx)
{
    ...
    if (DAC_FIFO_0 == idx) {
        ...
        dac_reg->fifo1_cnt &= ~(FIFO1_CNT_EN | FIFO1_CNT_IE);
    }
}
...
/* @brief set the DAC FIFO volume */
static int __dac_fifo_volume_set(struct device *dev, a_dac_fifo_e idx, uint8_t vol)
{
    struct acts_audio_dac *dac_reg = get_dac_reg_base(dev);
    uint32_t reg = dac_reg->fifoctl;
    ...
    /**
      ...
      *	- 0xf: -12db
      */
    if (vol > DAC_FIFO_MAX_VOL_LEVEL)
        vol = DAC_FIFO_MAX_VOL_LEVEL;

    if (DAC_FIFO_0 == idx) {
        reg &= ~DAC_FIFOCTL_FIFO0_VOL_MASK;
        reg |= DAC_FIFOCTL_FIFO0_VOL(vol);
    } else if (DAC_FIFO_1 == idx) {
        reg &= ~DAC_FIFOCTL_FIFO1_VOL_MASK;
        reg |= DAC_FIFOCTL_FIFO1_VOL(vol);
    } else {
        return -EINVAL;
    }
...
/* @brief get the DAC FIFO volume */
static int __dac_fifo_volume_get(struct device *dev, a_dac_fifo_e idx)
{
    struct acts_audio_dac *dac_reg = get_dac_reg_base(dev);
    uint32_t reg = dac_reg->fifoctl;
    int val;
    ...
    if (DAC_FIFO_0 == idx) {
        val = (reg & DAC_FIFOCTL_FIFO0_VOL_MASK) >> DAC_FIFOCTL_FIFO0_VOL_SHIFT;
    } else if (DAC_FIFO_1 == idx) {
        val = (reg & DAC_FIFOCTL_FIFO1_VOL_MASK) >> DAC_FIFOCTL_FIFO1_VOL_SHIFT;
    } else {
        val = -EINVAL;
    }
...
static int __dac_fifo_drq_level_set(struct device *dev, a_dac_fifo_e idx, uint8_t level)
{
    ...
    if (DAC_FIFO_0 == idx) {
        ...
        reg &= ~DAC_FIFOCTL_DRQ1_LEVEL_MASK;
        reg |= DAC_FIFOCTL_DRQ1_LEVEL(level);
    } else {
        return -EINVAL;
    }
...
static int __dac_fifo_drq_level_get(struct device *dev, a_dac_fifo_e idx)
{
    ...
    if (DAC_FIFO_0 == idx) {
        ...
        level = (reg & DAC_FIFOCTL_DRQ1_LEVEL_MASK) >> DAC_FIFOCTL_DRQ1_LEVEL_SHIFT;
    } else {
        level = -EINVAL;
    }
...
static uint32_t __dac_read_fifo_counter(struct device *dev, a_dac_fifo_e idx)
{
    ...
    if (DAC_FIFO_0 == idx) {
        ...
        val = dac_reg->fifo1_cnt & FIFO1_CNT_CNT_MASK;
    }
...
static int __dac_digital_enable(struct device *dev, a_dac_osr_e osr,
            audio_ch_mode_e type, uint8_t channel_type)
{
    ...
    reg &= ~(DAC_DIGCTL_DDEN | DAC_DIGCTL_ENDITH
            ...
            | DAC_DIGCTL_INTFRS3 | DAC_DIGCTL_OSRDA3
            | DAC_DIGCTL_DACHNUM | DAC_DIGCTL_MULT_DEVICE_MASK);

    if ((STEREO_MODE != type) && (MONO_MODE != type))
        return -EINVAL;

    /* OSRDA always set as multiple of (8 x INTFRS) */
    reg |= (osr << DAC_DIGCTL_OSRDA_SHIFT); /* set OSR + OSR3 */
    reg |= ((osr & 3) << DAC_DIGCTL_INTFRS_SHIFT); /* set INTFRS */
    reg |= ((osr >> 2) & 1) << DAC_DIGCTL_INTFRS3_SHIFT; /* set INTFRS3 */

    /* fs is 8k, fir2x/4x clk should div6 to match 8*256fs the same as before */
    if ((DAC_OSR_384X == osr) || (DAC_OSR_128X == osr))
        sys_write32(sys_read32(CMU_DACCLK) | (1 << CMU_DACCLK_DACOSCCLKDIV), CMU_DACCLK);
    ...
    if ((channel_type & AUDIO_CHANNEL_I2STX)
        ...
        LOG_INF("Enable DAC linkage with I2STX and SPDIFTX");
        ...
        LOG_INF("Enable DAC linkage with SPDIFTX");
...
static void __dac_digital_disable_fifo(struct device *dev, a_dac_fifo_e idx)
{
    ...
    if (DAC_FIFO_0 == idx) {
        ...
        dac_reg->digctl &= ~DAC_DIGCTL_DAF1M2DAEN; /* disable DAC_FIFO1 MIX to PCMBUF */
    }
}
...
/* @brief DAC works in single-end non-direct mode or direct mode (VRO) layout */
static int __dac_analog_single_end_cfg(struct device *dev, uint8_t lr_sel, bool vro_en)
{
    const struct phy_dac_config_data *cfg = dev->config;
    struct acts_audio_dac *dac_reg = get_dac_reg_base(dev);
    uint32_t reg0 = dac_reg->anactl0, reg1;
    ...
    /* 0: single mode; 1: diff mode */
    reg0 &= ~DAC_ANACTL0_DIFFM;
    ...
    if (vro_en) {
        /* direct mode enable */
        reg0 |= DAC_ANACTL0_BUFM;
        /* VRO output stage and op enable */
    ...
    if (lr_sel & LEFT_CHANNEL_SEL) {
        ...
        /* left channel INV enable  */
        reg0 |= DAC_ANACTL0_DAINVENL;
        /* left channel enable */
        reg0 |= DAC_ANACTL0_DAENL;
        /* PA output volume enable */
    ...
    if (lr_sel & RIGHT_CHANNEL_SEL) {
        /* PA output stage and op enable */
        reg0 |= (DAC_ANACTL0_PALNEN | DAC_ANACTL0_PALNOSEN);
        /* right channel INV enable  */
...
static void __dac_analog_diff_sh_cfg(struct device *dev, uint16_t shcl_pw,
                uint16_t shcl_set, bool curbias)
{
    struct acts_audio_dac *dac_reg = get_dac_reg_base(dev);
    uint32_t reg;
    ...
    reg &= ~DAC_ANACTL2_SHCL_SET_MASK;
    reg &= ~DAC_ANACTL2_SHCL_PW_MASK;
    reg &= ~DAC_ANACTL2_EN_CURBIAS;

    /* DAC SH clock divisor setting step2 */
    reg |= DAC_ANACTL2_SHCL_SET(shcl_set);

    /* DAC SH clock divisor setting step1 */
    reg |= DAC_ANACTL2_SHCL_PW(shcl_pw);

    if (curbias)
        reg |= DAC_ANACTL2_EN_CURBIAS;

    /* DAC SH clock enable */
    reg |= DAC_ANACTL2_SH_CLKEN;
...
static int __dac_analog_diff_cfg(struct device *dev, uint8_t lr_sel)
{
    const struct phy_dac_config_data *cfg = dev->config;
    struct acts_audio_dac *dac_reg = get_dac_reg_base(dev);
    ...
    /* left channel enable */
    if (lr_sel & LEFT_CHANNEL_SEL) {
        /* LN/LP output stage and op enable */
        reg0 |= (DAC_ANACTL0_PALPEN | DAC_ANACTL0_PALPOSEN
                | DAC_ANACTL0_PALNEN | DAC_ANACTL0_PALNOSEN);
        /* left channel enable */
        reg0 |= DAC_ANACTL0_DAENL;
        /* LN/LP PA out volume enable */
        reg0 |= (DAC_ANACTL0_SW1LP | DAC_ANACTL0_SW1LN);

        /* disable L INV */
        reg0 &= ~DAC_ANACTL0_DAINVENL;

        /* LN/LP playback enable */
        reg1 |= (DAC_ANACTL1_DPBMLP | DAC_ANACTL1_DPBMLN);
    }

    /* right channel enable */
    if (lr_sel & RIGHT_CHANNEL_SEL) {
        /* RN/RP output stage and op enable */
        reg0 |= (DAC_ANACTL0_PARPEN | DAC_ANACTL0_PARPOSEN
        ...
        /* RN/RP PA out volume enable */
        reg0 |= DAC_ANACTL0_SW1RP | DAC_ANACTL0_SW1RN;

        /* disable R INV */
        reg0 &= ~DAC_ANACTL0_DAINVENR;

        /* DAC R playback enable */
        reg1 |= DAC_ANACTL1_DPBMR;
    }

    /**
     * In case of the following situactions to enable the clock of DACANACLK.
     *	- DAC differential mode in new plan.
     *	- PA/VRO output overload detection enable.
     *	- Analog soft step mute function enable.
     */
#if (CONFIG_AUDIO_DAC_HIGH_PERFORMACE_DIFF_EN == 1)
    acts_clock_peripheral_enable(CLOCK_ID_DACANACLK);
    /* select high performance struction */
    reg0 |= DAC_ANACTL0_SEL_PLAN;
    /* DAC current set as high performance and use default value */
    reg0 |= DAC_ANACTL0_SEL_CUR(3);
    reg1 &= ~(DAC_ANACTL1_DPBMLP | DAC_ANACTL1_DPBMLN);
#else
    /* enable diff mode */
    reg0 |= DAC_ANACTL0_DIFFM;
    /* DAC current set as tridition struction */
    reg0 &= ~DAC_ANACTL0_SEL_CUR_MASK;
#endif
    ...
    /**
     * FIXME: HW issue
     * Here need to wait about 3ms for SH establish stable state.
     */
    if (!z_is_idle_thread_object(_current))
        k_sleep(K_MSEC(DAC_HIGH_PERFORMANCE_WAIT_SH_TIME_MS));
    else
        k_busy_wait(DAC_HIGH_PERFORMANCE_WAIT_SH_TIME_MS * 1000UL);

    __dac_analog_diff_sh_cfg(dev, CONFIG_AUDIO_DAC_HIGH_PERFORMANCE_SHCL_PW,
            CONFIG_AUDIO_DAC_HIGH_PERFORMANCE_SHCL_SET,
            CONFIG_AUDIO_DAC_HIGH_PERFORMANCE_SHCL_CURBIAS);
#endif
...
static int dac_physical_layout_cfg(struct device *dev)
{
    ...
    switch (layout) {
        case SINGLE_END_MODE:
            ret = __dac_analog_single_end_cfg(dev, lr_sel, false);
            break;
        case SINGLE_END_VOR_MODE:
            ret = __dac_analog_single_end_cfg(dev, lr_sel, true);
            break;
        case DIFFERENTIAL_MODE:
            ret = __dac_analog_diff_cfg(dev, lr_sel);
            break;
        default:
            ret = -1;
    }
...
static int dac_sample_rate_is_interpolation_x3(struct device *dev, audio_sr_sel_e sample_rate)
{
    ...
    osr = dac_sample_rate_to_osr(dev, sample_rate);
    if (osr < 0) {
        LOG_ERR("mapping sample rate:%d to osr error", sample_rate);
        return -EFAULT;
    }
...
static int dac_sample_rate_set(struct device *dev, audio_sr_sel_e sr_khz)
{
    ...
    osr = dac_sample_rate_to_osr(dev, sr_khz);
    if (osr < 0) {
        LOG_ERR("mapping sample rate:%d to osr error", sr_khz);
        return -EFAULT;
    }

    /* DAC main clock depends on OSR value */
    if (DAC_OSR_384X == osr) {
        mclk = MCLK_1536FS;
    } else if ((DAC_OSR_192X == osr) || (DAC_OSR_96X == osr)
                || (DAC_OSR_48X == osr)) {
        mclk = MCLK_768FS;
    } else if ((DAC_OSR_64X == osr) || (DAC_OSR_32X == osr)) {
        mclk = MCLK_256FS;
    } else {
        mclk = MCLK_512FS;
    }
...
static int dac_get_dma_info(struct device *dev, struct audio_out_dma_info *info)
{
    ...
    } else if ((AOUT_FIFO_DAC1 == info->fifo_type)
                || (AOUT_FIFO_DAC1_ONLY_SPDIF == info->fifo_type)) {
        info->dma_info.dma_chan = cfg->dma_fifo1.dma_chan;
        info->dma_info.dma_dev_name = cfg->dma_fifo1.dma_dev_name;
        info->dma_info.dma_id = cfg->dma_fifo1.dma_id;
    } else {
        return -ENOENT;
    }
...
/* @brief enable or disable ANC mix to DAC left/right channels function */
static int anc_mix2dac_ctl(struct device *dev, bool is_en)
{
    uint32_t key;
    ...
    if (is_en) {
        /* wait DAC interpolation stable for ANC */
        if (!z_is_idle_thread_object(_current))
            k_sleep(K_MSEC(ANC_MIX_TO_DAC_WAIT_STABLE_TIME_MS));
        else
            k_busy_wait(ANC_MIX_TO_DAC_WAIT_STABLE_TIME_MS * 1000UL);

        key = irq_lock();

        /* ANC register authority switches to CPU */
        sys_write32(sys_read32(ALL_REG_ACCESS_SEL_BASE) & ~ALL_REG_ACCESS_SEL_CPU_OR_DSP,
                    ALL_REG_ACCESS_SEL_BASE);

        /* enable ANC mix to DAC right/left channels */
        sys_write32(sys_read32(ANC_MIX_CTL_BASE) | (ANC_MIX_CTL_PLAY_MIX_REN | ANC_MIX_CTL_PLAY_MIX_LEN),
            ANC_MIX_CTL_BASE);

        /* ANC register authority switches to ANCDSP */
        sys_write32(sys_read32(ALL_REG_ACCESS_SEL_BASE) | ALL_REG_ACCESS_SEL_CPU_OR_DSP,
                    ALL_REG_ACCESS_SEL_BASE);
        ...
        /* disable ANC mix to DAC right/left channels */
        sys_write32(sys_read32(ANC_MIX_CTL_BASE) & ~(ANC_MIX_CTL_PLAY_MIX_REN | ANC_MIX_CTL_PLAY_MIX_LEN),
            ANC_MIX_CTL_BASE);
...
/* @brief ANC disable MIX to DAC as interpolation x3 */
static int anc_disable_for_interpolation_x3(struct device *dev, uint8_t sr)
{
    struct phy_dac_drv_data *data = dev->data;
    int ret = 0, ret0, ret1;

    if (data->is_anc_enable && data->sample_rate) {
        ret0 = dac_sample_rate_is_interpolation_x3(dev, data->sample_rate);
        if (ret0 < 0) {
            LOG_ERR("invalid old sample rate:%d", data->sample_rate);
            return -EINVAL;
        }
        ret1 = dac_sample_rate_is_interpolation_x3(dev, sr);
        if (ret1 < 0) {
            LOG_ERR("invalid new sample rate:%d", sr);
            return -EINVAL;
        }

        if (ret0 != ret1) {
            LOG_INF("sr{%d=>%d} disable ANC MIX to DAC", data->sample_rate, sr);
            anc_mix2dac_ctl(dev, false);
            ret = 1;
        }
    }
...
/* @brief ANC enable MIX to DAC as interpolation x3 */
static int anc_enable_for_interpolation_x3(struct device *dev)
{
    LOG_INF("enable ANC MIX to DAC");

    return anc_mix2dac_ctl(dev, true);;
}
...
static int dac_wait_fifo_empty(struct device *dev, a_dac_fifo_e idx, uint32_t timeout_ms)
{
    ...
    if ((DAC_FIFO_0 == idx)
        || ((DAC_FIFO_1 == idx) && (dac_reg->digctl & DAC_DIGCTL_DAF1M2DAEN))) {
...
static int phy_dac_enable(struct device *dev, void *param)
{
    ...
    dac_setting_t *dac_setting = out_param->dac_setting;
    int ret, ret_anc;
    uint8_t fifo_idx, osr = DAC_OSR_64X;
    ...
    osr = dac_sample_rate_to_osr(dev, out_param->sample_rate);
    if (osr < 0) {
    ...
    ret = __dac_digital_enable(dev, osr,
...
static void phy_dac_digital_isr(const void *arg)
{
    ...
    LOG_DBG("pcmbuf_cnt:0x%x fifo1_cnt 0x%x sdm_cnt 0x%x",
            dac_reg->pcm_buf_cnt, dac_reg->fifo1_cnt, dac_reg->sdm_samples_cnt);

    /* DAC auto mute detect pending */
    if (dac_reg->auto_mute_ctl & AUTO_MUTE_CTL_AMPD)
        dac_reg->auto_mute_ctl |= AUTO_MUTE_CTL_AMPD;

    /* DAC playback soft-mute done pending */
    if (dac_reg->digctl & DAC_DIGCTL_SMC_DONE_PD)
        dac_reg->digctl |= DAC_DIGCTL_SMC_DONE_PD;
    ...
    /* FIFO1 sample counter overflow irq pending */
    if (dac_reg->fifo1_cnt & FIFO1_CNT_IP) {
        data->ch[1].fifo_cnt += (AOUT_FIFO_CNT_MAX + 1);

        dac_reg->fifo1_cnt |= FIFO1_CNT_IP;

        if (data->ch[1].fifo_cnt_timestamp) {
            if (k_cyc_to_us_floor32(k_cycle_get_32() - data->ch[1].fifo_cnt_timestamp)
                < DAC_FIFO_CNT_MAX_SAME_SAMPLES_TIME_US) {
                __dac_fifo_counter_reset(dev, DAC_FIFO_1);
                data->ch[1].fifo_cnt_timestamp = 0;
            }
        }
        data->ch[1].fifo_cnt_timestamp = k_cycle_get_32();

        timestamp = k_cycle_get_32();
        while (dac_reg->fifo1_cnt & FIFO1_CNT_IP) {
            dac_reg->fifo1_cnt |= FIFO1_CNT_IP;
            if (k_cyc_to_us_floor32(k_cycle_get_32() - timestamp)
                > DAC_FIFO_CNT_CLEAR_PENDING_TIME_US) {
                LOG_ERR("failed to clear DAC FIFO1 PD:0x%x", dac_reg->fifo1_cnt);
                __dac_fifo_counter_reset(dev, DAC_FIFO_1);
            }
        }
    }
