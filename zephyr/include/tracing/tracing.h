...
/* Below IDs are user defined IDs used with systemview */
#define SYS_TRACE_ID_USR_OFFSET              (200u)
...
#define SYS_TRACE_ID_LCD_POST_OVERTIME       (6u + SYS_TRACE_ID_USR_OFFSET)

#define SYS_TRACE_ID_DE_DRAW                 (7u + SYS_TRACE_ID_USR_OFFSET)

#define SYS_TRACE_ID_DMA2D_EN                (8u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_COMPOSER_OVERFLOW       (9u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_COMPOSER_OVERVSYNC      (10u + SYS_TRACE_ID_USR_OFFSET)

#define SYS_TRACE_ID_IMG_DECODE              (11u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_IMG_HW_DECODE           (12u + SYS_TRACE_ID_USR_OFFSET)
...
#define SYS_TRACE_ID_GUI_WAIT_DRAW           (35u + SYS_TRACE_ID_USR_OFFSET)
...
#define SYS_TRACE_ID_VIEW_SCROLL_CB          (50u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_VIEW_MONITOR_CB         (51u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_VIEW_KEYEVENT_CB        (52u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_VIEW_SCROLL_EFFECT      (53u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_VIEW_SWITCH_EFFECT      (54u + SYS_TRACE_ID_USR_OFFSET)
...
#define SYS_TRACE_ID_RES_PRELOAD_ADD     	 (73u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_RES_PRELOAD_CANCEL      (74u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_RES_PRELOAD_ALLOC       (75u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_RES_PRELOAD_FREE        (76u + SYS_TRACE_ID_USR_OFFSET)

#define SYS_TRACE_ID_FLASH_READ              (80u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_FLASH_WRITE             (81u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_FLASH_ERASE             (82u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_FLASH_FLUSH             (83u + SYS_TRACE_ID_USR_OFFSET)

#define SYS_TRACE_ID_PIC_DECOMPRESS          (90u + SYS_TRACE_ID_USR_OFFSET)
