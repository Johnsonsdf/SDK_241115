...
/*!
 * struct dac_fifosrc_setting_t
 * @brief The setting of the dac fifosrc.
 */
typedef struct {
	uint8_t fifo_idx;
		/*!< The fifo index, 0 FIFO0 or 1 FIFO1 */
	uint8_t fifo_from_dsp;
		/*!< The fifo source type is dsp or not */
	void * dsp_audio_set_param;
		/*!< The callback function of dsp audio set param to dsp core */
} dac_fifosrc_setting_t;
