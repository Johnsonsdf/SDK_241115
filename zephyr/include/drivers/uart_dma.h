...
static inline int uart_dma_send_exit(struct device *dev)
{
	return uart_acts_dma_send_exit(dev);
}
...
static inline int uart_dma_receive_exit(struct device *dev)
{
	return uart_acts_dma_receive_exit(dev);
}
...
static inline int uart_dma_receive_remain(struct device *dev)
{
	return uart_acts_dma_receive_remain(dev);
	//return 0;
}
