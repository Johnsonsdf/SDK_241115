...
#ifndef PINCTRL_LEOPARD_H_
#define PINCTRL_LEOPARD_H_
...
#define GPIO_CTL_PULLUP_4K7					(0x1 << 10)
...
#define I2CMT_MFP_CFG(x)	(GPIO_CTL_MFP(x)|GPIO_CTL_PULLUP_4K7|GPIO_CTL_PADDRV_LEVEL(3))
...
#endif
#ifndef LCD_CLK_PADDRV_LEVEL
#  define LCD_CLK_PADDRV_LEVEL (1)
#endif

#define LCD_MFP_SEL                  (19 | GPIO_CTL_PADDRV_LEVEL(LCD_PADDRV_LEVEL))
#define LCD_MFP_CLK_SEL              (19 | GPIO_CTL_PADDRV_LEVEL(LCD_CLK_PADDRV_LEVEL))
...
/* knob gpio */
#define GPIOKNOB_MFP_INT_CFG (GPIO_CTL_SMIT | GPIO_CTL_PULLUP | GPIO_CTL_GPIO_INEN | GPIO_CTL_INTC_EN | GPIO_CTL_INC_TRIGGER_DUAL_EDGE)
#define GPIOKNOB_MFP_CFG (GPIO_CTL_SMIT | GPIO_CTL_PULLUP | GPIO_CTL_GPIO_INEN )
...
#define SPINOR_MFP_CFG (GPIO_CTL_MFP(SPINOR_MFP_SEL)| GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(3) | GPIO_CTL_SR)
#define SPINOR_MFP_PU_CFG (GPIO_CTL_MFP(SPINOR_MFP_SEL)| GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(3) | GPIO_CTL_PULLUP | GPIO_CTL_SR)

#define SPINOR2_MFP_SEL             3
#define SPINOR2_MFP_CFG (GPIO_CTL_MFP(SPINOR2_MFP_SEL)| GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(3))

#define SPI3_MFP_SEL             4
#define SPI3_MFP_CFG (GPIO_CTL_MFP(SPI3_MFP_SEL)| GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(3))
...
#define SPINAND_MFP_CFG (GPIO_CTL_MFP(SPINAND_MFP_SEL) | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(3))
#define SPINAND_MFP_PU_CFG (GPIO_CTL_MFP(SPINAND_MFP_SEL)| GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(3) | GPIO_CTL_PULLUP)
...
#define BATNTC_REF_MFP_SEL      28
/* NTC ref config should pull up to vcc 3.4v */
#define BATNTC_REF_MFP_CFG (GPIO_CTL_MFP(BATNTC_REF_MFP_SEL) | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(3) | GPIO_CTL_PULLUP_STRONG)

#endif /* PINCTRL_LEOPARD_H_ */
