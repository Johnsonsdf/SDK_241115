 ...
 */
#if defined(CONFIG_ACTLOG)
#define LOG_ERR(...)    ACT_LOG(LOG_LEVEL_ERR, __VA_ARGS__)
#else
 ...
 */
#if defined(CONFIG_ACTLOG)
#define LOG_WRN(...)    ACT_LOG(LOG_LEVEL_WRN, __VA_ARGS__)
#else
 ...
 */
#if defined(CONFIG_ACTLOG)
#define LOG_INF(...)    ACT_LOG(LOG_LEVEL_INF, __VA_ARGS__)
#else
 ...
 */
#if defined(CONFIG_ACTLOG)
#define LOG_DBG(...)    ACT_LOG(LOG_LEVEL_DBG, __VA_ARGS__)
#else
