...
#ifndef _SENSOR_HR_HX3605_H
#define _SENSOR_HR_HX3605_H
...
//sensor address
/******************************************************************************/
#define HX3605_ADR				(0x44)  // i2c address

/******************************************************************************/
//sensor device
//[type] sensor_dev_t: sensor_hw_t + sensor_io_t + cfg[] + func[] + task
/******************************************************************************/
#define SENSOR_DEV_HR_HX3605                                                     \
	/*[hw] name  adr,len(adr,reg)  chip(reg,id)    sta(reg,rdy)   dat(reg,len,cmd,to)*/   \
	{ "HX3605",  HX3605_ADR,1,1,   0x00,0x25,      REG_NULL,0x0,  REG_NULL,16,0x0,1000 }, \
...
//sensor task
/******************************************************************************/
extern const i2c_task_t hx3605_task;
