...
#ifndef _SENSOR_HR_VC9201_H
#define _SENSOR_HR_VC9201_H
...
//sensor address
/******************************************************************************/
#define VC9201_ADR				(0x33)  // i2c address

/******************************************************************************/
//sensor device
//[type] sensor_dev_t: sensor_hw_t + sensor_io_t + cfg[] + func[] + task
/******************************************************************************/
#define SENSOR_DEV_HR_VC9201                                                      \
	/*[hw] name  adr,len(adr,reg)  chip(reg,id)    sta(reg,rdy)   dat(reg,len,cmd,to)*/   \
	{ "VC9201",  VC9201_ADR,1,1,   0x00,0x21,      REG_NULL,0x0,  REG_NULL,16,0x0,1000 }, \
...
//sensor task
/******************************************************************************/
extern const i2c_task_t vc9201_task;
