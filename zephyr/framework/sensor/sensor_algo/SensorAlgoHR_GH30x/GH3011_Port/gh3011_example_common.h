...
/// version string
#define GH30X_EXAMPLE_VER_STRING            "example code v0.5.0 (For hbd_ctrl lib v0.7.5.0 and later)\r\n"
...
#undef __BPF_DET_SUPPORT__
#define __BPF_DET_SUPPORT__ (0)
#endif
...
#define GSENSOR_SOFT_FIFO_BUFFER_MAX_LEN    (255)
...
// bpf
extern const ST_REGISTER bpf_reg_config_array[];
extern const uint8_t bpf_reg_config_array_len;
