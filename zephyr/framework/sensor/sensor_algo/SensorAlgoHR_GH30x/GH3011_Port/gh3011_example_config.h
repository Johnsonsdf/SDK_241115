...
/// dbg buffer len, should define >= max fifo thr of all func enabled (use heap space)
...
/// bpf detect support
#define __BPF_DET_SUPPORT__                (1)

/// bpf fifo thr cnt config
#define __BPF_FIFO_THR_CNT_CONFIG__        (128)
