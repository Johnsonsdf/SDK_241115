...
/* bpf config */
const ST_REGISTER bpf_reg_config_array[] = 
{
    {0x0100, 0xf530}, 
    {0x0102, 0x09C4}, 
    {0x0104, 0xba98}, 
...
const uint8_t bpf_reg_config_array_len = sizeof(bpf_reg_config_array)/sizeof(bpf_reg_config_array[0]);
