...
/**
 * @brief get session run debug info
 *
 * @param session Address of session
 * @param index   debug info index
 *
 * @return the debug info of the index
 */
uint32_t dsp_session_get_debug_info(struct dsp_session *session, uint32_t index);

/**
 * @brief get session run pcmbuf info
 *
 * @param session Address of session
 *
 * @param pcmbuf Address of pcmbuf info
 *
