...
#define __ramdump_sram_start						Image$$ER_ATTDATA$$Base
#define __ramdump_sram_end							Image$$ER_UI_SRAM_NOSAVE$$Base
#define __ramdump_psram_start						Image$$ER_ATTDATA$$Base
#define __ramdump_psram_end							Image$$ER_UI_SRAM_NOSAVE$$Base
