...
static int picarray_load(lvgl_img_loader_t * loader, uint16_t index, lv_img_dsc_t * dsc, lv_point_t * offset);
static uint16_t picarray_get_count(lvgl_img_loader_t *loader);

static int picregion_load(lvgl_img_loader_t * loader, uint16_t index, lv_img_dsc_t * dsc, lv_point_t * offset);
...
static int picgroup_load(lvgl_img_loader_t * loader, uint16_t index, lv_img_dsc_t * dsc, lv_point_t * offset);
...
int lvgl_img_loader_set_picarray(lvgl_img_loader_t * loader,
		const lv_img_dsc_t * dsc, const lv_point_t * offsets, uint16_t num)
{
