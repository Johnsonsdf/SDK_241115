...
/* SCO  settings */
/* #define BT_VOICE_CVSD_16BIT     0x0060 */		/* Define in conn.h */
...
//#endif /* CONFIG_BT_BREDR */
	...
	BT_DEV_REMOTE_NAME_REQ,		/* For br request remote name */
...
//#endif
	...
	char			br_name[CONFIG_BT_DEVICE_NAME_MAX + 1];		/* BR name */
#endif

	bt_addr_t read_bd_addr;
...
typedef uint8_t (*bt_hci_hf_codec_func)(struct bt_conn *conn);
