...
#define LV_SCR_LOAD_ANIM_ZOOM_MIN (LV_IMG_ZOOM_NONE / 2)
...
typedef enum {
    ...
    LV_SCR_LOAD_ANIM_ZOOM_LEFT,
    LV_SCR_LOAD_ANIM_ZOOM_RIGHT,
    LV_SCR_LOAD_ANIM_ZOOM_IN,
    LV_SCR_LOAD_ANIM_ZOOM_OUT,
} lv_scr_load_anim_t;
