...
/*Use GPU on Actions platform*/
#ifndef LV_USE_GPU_ACTS
    #ifdef CONFIG_LV_USE_GPU_ACTS
        #define LV_USE_GPU_ACTS CONFIG_LV_USE_GPU_ACTS
    #else
        #define LV_USE_GPU_ACTS 0
    #endif
#endif

#if LV_USE_GPU_ACTS
    /*Actions DMA2D*/
    #ifndef LV_USE_GPU_ACTS_DMA2D
        #ifdef CONFIG_LV_USE_GPU_ACTS_DMA2D
            #define LV_USE_GPU_ACTS_DMA2D CONFIG_LV_USE_GPU_ACTS_DMA2D
        #else
            #define LV_USE_GPU_ACTS_DMA2D 0
        #endif
    #endif

    #ifndef LV_GPU_ACTS_DMA2D_SIZE_LIMIT
        #ifdef CONFIG_LV_GPU_ACTS_DMA2D_SIZE_LIMIT
            #define LV_GPU_ACTS_DMA2D_SIZE_LIMIT CONFIG_LV_GPU_ACTS_DMA2D_SIZE_LIMIT
        #else
            #define LV_GPU_ACTS_DMA2D_SIZE_LIMIT 32
        #endif
    #endif

    /*Verisilicon VG-Lite*/
    #ifndef LV_USE_GPU_ACTS_VG_LITE
        #ifdef CONFIG_LV_USE_GPU_ACTS_VG_LITE
            #define LV_USE_GPU_ACTS_VG_LITE CONFIG_LV_USE_GPU_ACTS_VG_LITE
        #else
            #define LV_USE_GPU_ACTS_VG_LITE 0
        #endif
    #endif

    #ifndef LV_GPU_ACTS_VG_LITE_SIZE_LIMIT
        #ifdef CONFIG_LV_GPU_ACTS_VG_LITE_SIZE_LIMIT
            #define LV_GPU_ACTS_VG_LITE_SIZE_LIMIT CONFIG_LV_GPU_ACTS_VG_LITE_SIZE_LIMIT
        #else
            #define LV_GPU_ACTS_VG_LITE_SIZE_LIMIT 64
        #endif
    #endif

    #ifndef LV_GPU_ACTS_VG_LITE_COMMAND_BUFFER_SIZE
        #ifdef CONFIG_LV_GPU_ACTS_VG_LITE_COMMAND_BUFFER_SIZE
            #define LV_GPU_ACTS_VG_LITE_COMMAND_BUFFER_SIZE CONFIG_LV_GPU_ACTS_VG_LITE_COMMAND_BUFFER_SIZE
        #else
            #define LV_GPU_ACTS_VG_LITE_COMMAND_BUFFER_SIZE 32
        #endif
    #endif

    /*Actions JPEG*/
    #ifndef LV_USE_GPU_ACTS_JPG
        #ifdef CONFIG_LV_USE_GPU_ACTS_JPG
            #define LV_USE_GPU_ACTS_JPG CONFIG_LV_USE_GPU_ACTS_JPG
        #else
            #define LV_USE_GPU_ACTS_JPG 0
        #endif
    #endif

    /*Actions Decompresser*/
    #ifndef LV_USE_GPU_ACTS_SW_DECODER
        #ifdef CONFIG_LV_USE_GPU_ACTS_SW_DECODER
            #define LV_USE_GPU_ACTS_SW_DECODER CONFIG_LV_USE_GPU_ACTS_SW_DECODER
        #else
            #define LV_USE_GPU_ACTS_SW_DECODER 0
        #endif
    #endif
...
#ifndef LV_USE_STRACE
#  ifdef CONFIG_LV_USE_STRACE
#    define LV_USE_STRACE CONFIG_LV_USE_STRACE
#  else
#    define  LV_USE_STRACE  0
#  endif
#endif
...
#ifndef LV_ATTRIBUTE_VERY_FAST_MEM
    #define LV_ATTRIBUTE_VERY_FAST_MEM LV_ATTRIBUTE_FAST_MEM
#endif
