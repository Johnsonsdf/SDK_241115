...
/** Describe the properties of the glyph bitmap for SVG (VG-Lite) font */
typedef struct {
    float scale; /**< scale factor*/
    float shift_x; /**< subpixel shift x after scaling*/
    float shift_y; /**< subpixel shift y after scaling*/
    float path_box[4]; /**< path bounding box specified as x1,y1,x2,y2 ([x1,x2] * [y1,y2])*/
    int path_len; /**< length of path_data */
    float * path_data; /**< store the glyphs for VG-Lit path */
} lv_svgfont_bitmap_dsc_t;
