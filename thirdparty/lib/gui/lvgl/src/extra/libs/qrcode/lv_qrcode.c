 ...
 * @param ecc error correction level (enum qrcodegen_Ecc)
 * @return LV_RES_OK: if no error; LV_RES_INV: on error
 */
lv_res_t lv_qrcode_update(lv_obj_t * qrcode, const void * data, uint32_t data_len, int ecc)
{
    lv_color_t c;
    c.full = 1;
