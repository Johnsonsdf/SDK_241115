 ...
 */
void * lv_mem_alloc_debug(size_t size, const char *func);
#define lv_mem_alloc(size) lv_mem_alloc_debug(size, __func__)

/**
 * Free an allocated data
 * @param data pointer to an allocated memory
 */
void lv_mem_free_debug(void * data, const char *func);
#define lv_mem_free(data) lv_mem_free_debug(data, __func__)
 ...
 */
void * lv_mem_realloc_debug(void * data_p, size_t new_size, const char *func);
#define lv_mem_realloc(data_p, new_size) lv_mem_realloc_debug(data_p, new_size, __func__)
