...
enum {
    ...
    /**
     * Actions' custom color formats as follows:
     */
    LV_IMG_CF_ETC2_EAC,

    LV_IMG_CF_ARGB_6666,
    LV_IMG_CF_ARGB_1555,
    LV_IMG_CF_ALPHA_1BIT_LE,
    LV_IMG_CF_ALPHA_4BIT_LE,
    LV_IMG_CF_INDEXED_8BIT_ACTS, /**< Insert 32-bit palette size before palette colors, based on LV_IMG_CF_INDEXED_8BIT*/
...
#if LV_COLOR_DEPTH == 16 && LV_COLOR_16_SWAP == 0
    LV_IMG_CF_RGB_565 = LV_IMG_CF_TRUE_COLOR,
    LV_IMG_CF_ARGB_8565 = LV_IMG_CF_TRUE_COLOR_ALPHA,
#elif LV_COLOR_DEPTH == 32
    LV_IMG_CF_ARGB_8888 = LV_IMG_CF_TRUE_COLOR_ALPHA,
    LV_IMG_CF_XRGB_8888 = LV_IMG_CF_TRUE_COLOR,
#endif
