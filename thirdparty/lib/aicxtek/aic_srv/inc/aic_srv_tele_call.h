...
*/
int32_t aic_srv_tele_call_volte_enable(uint8_t card_id, bool enable);

/**
* aic_srv_tele_call_volte_is_enable - the get VoLTE status api.
* @card_id: [IN] sim id, 0-sim 1, 1-sim2, currently only support single card(0).
* @p_enable: [OUT] whether VoLTE is enabled.
* Return: if success return 0, else return other value.
*/
int32_t aic_srv_tele_call_volte_is_enable(uint8_t card_id, bool *p_enable);
...
/**
* aic_srv_tele_call_get_auto_answer
* Return: true, auto answer, false not auto answer.
*/
bool aic_srv_tele_call_get_auto_answer(void);
