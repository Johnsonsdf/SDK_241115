...
..\..\tools\config_maker\cfg_maker.exe Objects\config.dat.o out\defcfg.bin 33 0

..\..\tools\config_maker\xml_maker.exe Objects\config.xml.o out\config.xml ZS308A_V1.0
