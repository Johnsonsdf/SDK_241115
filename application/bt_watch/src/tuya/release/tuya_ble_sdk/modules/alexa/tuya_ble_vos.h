...
#define AUDIO_FORMAT           AudioFormat_OPUS_16KHZ_32KBPS_CBR_0_20MS
...
#define AUDIO_RESULT_DATA_MAX_PACKET_SIZE    512
	...
	#define  TUYA_BLE_AUDIO_BUFFER_ENCODED_NUM  100
#elif (AUDIO_FORMAT == AudioFormat_OPUS_16KHZ_32KBPS_CBR_0_20MS)
	#define  TUYA_BLE_VOS_DATA_BUFFER_SIZE  (CODEC_OUT_RING_BUFF_SIZE*6)
	#define  TUYA_BLE_AUDIO_BUFFER_ENCODED_NUM  20
#else
	#error "The current audio encoding format is not supported.!"
#endif
...
//tuya_ble_status_t tuya_vos_audio_data_send(int16_t * p_data,uint16_t samples);
