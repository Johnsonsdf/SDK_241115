...
typedef struct {
    ...
    uint8_t beacon_key[BEACON_KEY_LEN];    //n 
    uint8_t bound_flag;
...
*/
typedef enum{
    TUYA_BLE_DP_ID_BROADCAST_MODE = 1,
    TUYA_BLE_DP_ID_SWITCH = 3,
    TUYA_BLE_DP_ID_BATTERY_PERCENTAGE = 4,
    TUYA_BLE_DP_ID_VOLUME_SET = 5,
    TUYA_BLE_DP_ID_CHANGE_CONTROL = 6,
    TUYA_BLE_DP_ID_PLAY_PAUSE = 7,
    TUYA_BLE_DP_ID_DEVICE_FIND = 11,
    TUYA_BLE_DP_ID_RIGHTEAR_BATTERY_PERCENTAGE = 15,
    TUYA_BLE_DP_ID_LEFTEAR_BATTERY_PERCENTAGE = 16,
    TUYA_BLE_DP_ID_COUNTDOWN = 17,
    TUYA_BLE_DP_ID_EQ_MODE = 18,
}tuya_ble_dp_id_e;
...
{
	tuya_ble_sys_settings_t  sys_settings;
	//tuya_ble_auth_settings_t auth_setting;
    uint8_t tuya_ble_pair_rand[6];
    uint8_t tuya_ble_connect_status;
}tuys_ble_tws_role_switch_info_t;
...
typedef struct 
{
    uint8_t is_valid;
    uint8_t countdown; 
}tuya_ble_count_down_set_t;

//extern tuya_ble_count_down_set_t tuya_ble_count_down_set;
