...
typedef struct sw_view_data {
	...
	/* lvgl resource */
	lv_img_dsc_t img_dsc_bg[NUM_SW_BG_IMGS];
	lv_img_dsc_t img_dsc_btn[NUM_SW_BTN_BMPS];
	lv_img_dsc_t img_dsc_min_num[10];
	lv_img_dsc_t img_dsc_sec_num[10];
	lv_img_dsc_t img_dsc_ms_num[10];
...
static int _stopwatch_view_layout(view_data_t *view_data)
{
	...
	/* create reset button */
	data->obj_sw_btns[BTN_RESET] = lv_imgbtn_create(data->obj_sw_bg[BMP_SW_BG]);
	...
	lv_imgbtn_set_src(data->obj_sw_btns[BTN_RESET], LV_IMGBTN_STATE_RELEASED, NULL, &data->img_dsc_btn[BTN_RESET_BMP], NULL);
	lv_imgbtn_set_src(data->obj_sw_btns[BTN_RESET], LV_IMGBTN_STATE_PRESSED, NULL, &data->img_dsc_btn[BTN_RESET_BMP_P], NULL);
	lv_imgbtn_set_src(data->obj_sw_btns[BTN_RESET], LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &data->img_dsc_btn[BTN_RESET_BMP], NULL);
	lv_imgbtn_set_src(data->obj_sw_btns[BTN_RESET], LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &data->img_dsc_btn[BTN_RESET_BMP_P], NULL);

	/* create start button */
	data->obj_sw_btns[BTN_START] = lv_imgbtn_create(data->obj_sw_bg[BMP_SW_BG]);
	...
	lv_imgbtn_set_src(data->obj_sw_btns[BTN_START], LV_IMGBTN_STATE_RELEASED, NULL, &data->img_dsc_btn[BTN_START_BMP], NULL);
	lv_imgbtn_set_src(data->obj_sw_btns[BTN_START], LV_IMGBTN_STATE_PRESSED, NULL, &data->img_dsc_btn[BTN_START_BMP_P], NULL);
	lv_imgbtn_set_src(data->obj_sw_btns[BTN_START], LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &data->img_dsc_btn[BTN_STOP_BMP], NULL);
	lv_imgbtn_set_src(data->obj_sw_btns[BTN_START], LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &data->img_dsc_btn[BTN_STOP_BMP_P], NULL);
...
static int _stopwatch_view_delete(view_data_t *view_data)
{
	...
	if (data) {
		...
		lv_obj_del(data->obj_sw_min);
		lv_obj_del(data->obj_sw_sec);
		lv_obj_del(data->obj_sw_ms);
...
int _stopwatch_view_handler(uint16_t view_id, uint8_t msg_id, void * msg_data)
{
...
VIEW_DEFINE(stopwatch_view, _stopwatch_view_handler, NULL, \
