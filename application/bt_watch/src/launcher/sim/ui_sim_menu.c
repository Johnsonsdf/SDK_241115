...
int _ui_sim_log_set_handler(uint16_t view_id, uint8_t msg_id, void * msg_data)
{
...
VIEW_DEFINE(ui_sim_log_set, _ui_sim_log_set_handler, NULL, \
...
int _ui_sim_power_set_handler(uint16_t view_id, uint8_t msg_id, void * msg_data)
{
	view_data_t *view_data = view_get_data(view_id);
    int ret = 0;
	switch (msg_id) {
...
VIEW_DEFINE(ui_sim_power_set, _ui_sim_power_set_handler, NULL, \
...
int _ui_sim_device_info_handler(uint16_t view_id, uint8_t msg_id, void * msg_data)
{
	view_data_t *view_data = view_get_data(view_id);
    int ret = 0;
	switch (msg_id) {
...
VIEW_DEFINE(ui_sim_device_info, _ui_sim_device_info_handler, NULL, \
...
int _ui_sim_menu_handler(uint16_t view_id, uint8_t msg_id, void * msg_data)
{
	view_data_t *view_data = view_get_data(view_id);
    int ret = 0;
	switch (msg_id) {
...
VIEW_DEFINE(ui_sim_menu, _ui_sim_menu_handler, NULL, \
