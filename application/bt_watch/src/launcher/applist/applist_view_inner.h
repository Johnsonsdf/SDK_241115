...
typedef struct {
	...
	void (* update_icon)(struct applist_ui_data * data, uint8_t idx, const lv_img_dsc_t * src);
 ...
 **********************/
/** Common functions */
const lv_img_dsc_t * applist_get_icon(applist_ui_data_t *data, uint8_t idx);
