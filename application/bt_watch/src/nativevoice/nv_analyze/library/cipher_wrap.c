...
#else
#include <stdlib.h>
#define mbedtls_calloc    app_mem_malloc
#define mbedtls_free       app_mem_free
#endif
...
{
    void *ctx = mbedtls_calloc(sizeof( mbedtls_gcm_context ) );
...
{
    void *ctx = mbedtls_calloc(sizeof( mbedtls_ccm_context ) );
...
{
    mbedtls_aes_context *aes = mbedtls_calloc(sizeof( mbedtls_aes_context ) );
...
{
    mbedtls_aes_xts_context *xts_ctx = mbedtls_calloc(sizeof( *xts_ctx ) );
...
static void * camellia_ctx_alloc( void )
{
    ...
    ctx = mbedtls_calloc(sizeof( mbedtls_camellia_context ) );
...
static void * aria_ctx_alloc( void )
{
    ...
    ctx = mbedtls_calloc(sizeof( mbedtls_aria_context ) );
...
{
    mbedtls_des_context *des = mbedtls_calloc(sizeof( mbedtls_des_context ) );
...
static void * des3_ctx_alloc( void )
{
    ...
    des3 = mbedtls_calloc(sizeof( mbedtls_des3_context ) );
...
static void * blowfish_ctx_alloc( void )
{
    ...
    ctx = mbedtls_calloc(sizeof( mbedtls_blowfish_context ) );
...
static void * arc4_ctx_alloc( void )
{
    ...
    ctx = mbedtls_calloc(sizeof( mbedtls_arc4_context ) );
...
static void * chacha20_ctx_alloc( void )
{
    ...
    ctx = mbedtls_calloc(sizeof( mbedtls_chacha20_context ) );
...
static void * chachapoly_ctx_alloc( void )
{
    ...
    ctx = mbedtls_calloc(sizeof( mbedtls_chachapoly_context ) );
