...
void anim_img_set_src_picarray(lv_obj_t *obj, const lv_img_dsc_t * src, const lv_point_t * offset, uint16_t cnt)
{
	anim_img_t *animimg = (anim_img_t *)obj;
...
void anim_img_set_duration(lv_obj_t *obj, uint16_t delay, uint16_t duration)
{
	anim_img_t *animimg = (anim_img_t *)obj;
...
void anim_img_set_repeat(lv_obj_t *obj, uint16_t delay, uint16_t count)
{
	anim_img_t *animimg = (anim_img_t *)obj;
...
void anim_img_stop(lv_obj_t *obj)
{
	...
	if (animimg->started) {
		animimg->started = 0;
		lv_anim_del(obj, anim_img_exec_cb);
	}
}
