...
#define MIN_RESULT_NUM          (2)
#define CFO_RESULT_NUM          (4)
...
int rf_rx_ber_test_channel(_bt_mp_test_arg_t *mp_arg, u8_t channel, u32_t cap, s16_t *rssi_val, u32_t *ber_val);
