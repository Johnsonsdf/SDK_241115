...
DEFINES := -DCONFIG_CPU_CORTEX_M4 -DCONFIG_SOC_LARK -DCONFIG_FPU -DCONFIG_FP_HARDABI
...
DEFINES := -DCONFIG_CPU_CORTEX_M4 -DCONFIG_SOC_LARK

ASFLAGS			+= 	-nostdinc -ffreestanding -Wa,--fatal-warnings	\
				-mcpu=cortex-m4 -mthumb  -Werror -Wmissing-include-dirs	\
				-D__ASSEMBLY__	\
				${DEFINES} ${INCLUDES} -DDEBUG=${DEBUG} -g
CFLAGS			+= 	-nostdinc  -ffreestanding -Wall  -mfloat-abi=hard  \
				 -mcpu=cortex-m4 -mthumb  -Wmissing-include-dirs	 \
				 -std=gnu99 -c -Os  -mno-unaligned-access  \
				${DEFINES} ${INCLUDES} -DDEBUG=${DEBUG} -g -gdwarf-4 -mabi=aapcs -mfpu=fpv4-sp-d16
...
ASFLAGS			+= --target=arm-arm-none-eabi -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -masm=auto \
					-mlittle-endian -gdwarf-3 -Wa,armasm,--pd -D__ASSEMBLY__ \
				${DEFINES} ${INCLUDES}

CFLAGS			+= -c -std=c99   -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard  -mthumb \
