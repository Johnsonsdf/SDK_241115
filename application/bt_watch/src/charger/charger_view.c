...
typedef struct charger_view_data {
	...
	lv_img_dsc_t img_dsc_charger_bg[NUM_CHARGER_IMGS];
...
int _charger_view_handler(uint16_t view_id, uint8_t msg_id, void *msg_data)
{
...
VIEW_DEFINE(charger_view, _charger_view_handler, NULL, \
