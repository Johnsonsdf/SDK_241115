...
#ifdef CONFIG_ALARM_APP
	{ .id = ALARM_MSGBOX_ID, .order = 0, .popup_cb = alarm_msgbox_popup_cb, },
#endif
#ifdef CONFIG_OTA_BACKGROUND
	{ .id = OTA_MSGBOX_ID, .order = 0, .popup_cb = ota_msgbox_popup_cb, },
#endif
#ifdef CONFIG_BT_CALL_APP
	{ .id = BTCALL_MSGBOX_ID, .order = 0, .popup_cb = btcall_msgbox_popup_cb, },
#endif

	{ .id = LPOWER_MSGBOX_ID, .order = 0, .popup_cb = lpower_msgbox_popup_cb, },
};
