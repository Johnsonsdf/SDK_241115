...
typedef struct  // 固件烧录设置
{
    ...
    cfg_uint8   Erase_Entire_Storage;                     // 烧录前擦除所有数据, CFG_TYPE_BOOL
...
#define CFG_ID_FACTORY_SETTINGS         0x03
#define CFG_ID_BT_CALL_VOLUME_TABLE     0x04
#define CFG_ID_VOICE_VOLUME_TABLE       0x05
#define CFG_ID_VOLUME_SETTINGS          0x06
#define CFG_ID_BT_CALL_OUT_DAE          0x07
#define CFG_ID_BT_CALL_MIC_DAE          0x08
#define CFG_ID_BT_CALL_QUALITY          0x09
#define CFG_ID_IGSPEECH_USER_SETTINGS   0x0A
#define CFG_ID_BT_MUSIC_DAE             0x0B
