...
void bt_call_start_play(void)
{
	...
	/* create stream to receive sco data from bt */
	...
	/* output_stream is NULL,default dac output */
	...
	/* capture_input_stream is NULL,default adc input */
	init_param.capture_input_stream = NULL;
	/* capture_output_stream will receive data decoded by decoder */
