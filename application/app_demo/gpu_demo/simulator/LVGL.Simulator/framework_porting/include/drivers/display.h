...
enum display_pixel_format {
	...
	PIXEL_FORMAT_XRGB_8888		= BIT(6),
	PIXEL_FORMAT_BGRA_6666		= BIT(7),
	PIXEL_FORMAT_RGBA_6666		= BIT(8),
	PIXEL_FORMAT_BGRA_5658		= BIT(9),
	PIXEL_FORMAT_BGRA_5551		= BIT(10),

	PIXEL_FORMAT_I8		= BIT(11),
	PIXEL_FORMAT_I4		= BIT(12),
	PIXEL_FORMAT_I2		= BIT(13),
	PIXEL_FORMAT_I1		= BIT(14),

	PIXEL_FORMAT_A8		= BIT(15),
	PIXEL_FORMAT_A4		= BIT(16),
	PIXEL_FORMAT_A2		= BIT(17),
	PIXEL_FORMAT_A1		= BIT(18),
	PIXEL_FORMAT_A4_LE	= BIT(19), /* little endian */
	PIXEL_FORMAT_A1_LE	= BIT(20), /* little endian */
};
