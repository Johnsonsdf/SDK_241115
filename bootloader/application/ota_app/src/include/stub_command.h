...
typedef enum
{
    ...
    STUB_CMD_ATT_FREAD                      = 0x0408,
    STUB_CMD_ATT_READ_TESTINFO              = 0x0409,
    STUB_CMD_ATT_WRITE_TESTINFO             = 0x040A,
    STUB_CMD_ATT_REBOOT_TIMEOUT             = 0x040B,
    STUB_CMD_ATT_REPORT_PARA                = 0x040C,
    STUB_CMD_ATT_GET_TEST_RESULT            = 0x040D,
    STUB_CMD_ATT_INFORM_STATE               = 0x040E,
    STUB_CMD_ATT_CFO_TX_BEGIN               = 0x0456,
    STUB_CMD_ATT_CFO_TX_STOP                = 0x0457,
    STUB_CMD_ATT_BER_TX_BEGIN               = 0x0458,
    STUB_CMD_ATT_BER_TX_STOP                = 0x0459,
    STUB_CMD_ATT_FILE_OPEN                  = 0x0480,
    STUB_CMD_ATT_FILE_READ                  = 0x0481,
    STUB_CMD_ATT_FILE_WRITE                 = 0x0482,
    STUB_CMD_ATT_FILE_CLOSE                 = 0x0483,
    STUB_CMD_ATT_NAK                        = 0x04FD,
    STUB_CMD_ATT_ACK                        = 0x04FE,
    STUB_CMD_ATT_POLL                       = 0x04FF,
    STUB_CMD_ATT_HCI_WRITE_CMD              = 0x0450,
    STUB_CMD_ATT_HCI_EVENT_READ             = 0x0451,
    STUB_CMD_ATT_RESET_CONTROLLER           = 0x0452,
    STUB_CMD_ATT_DOWNLOAD_PATCH             = 0x0453,
    STUB_CMD_ATT_WRITE_TRIM_CAP             = 0x0454,
    STUB_CMD_ATT_READ_TRIM_CAP              = 0x0455,
    STUB_CMD_ATT_RETRUN_CFO_VAL             = 0x0456,
}ATT_COMMAND_E;
