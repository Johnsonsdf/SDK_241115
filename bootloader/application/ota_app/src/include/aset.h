...
typedef struct
{
    u8_t  magic;                ///< ASET magic: 0xE0
    u8_t  reserved0;
    u8_t  opcode;               ///< ASET operation code
    u8_t  reserved1;
    u32_t reserved2;
    u32_t para_length;          ///< ASET parameter length, byte unit
}aset_cmd_packet_t;
 ...
 *  \details
 */
int ReadASETPacket(usp_handle_t *aset_op, u8_t* payload, u32_t size);
#endif
