...
void bt_dut_mode(void)
{
    ...
    bqb_info->tx_data[2] = 0x0d;
    bqb_info->tx_data[3] = 0x00;
    bqb_info->tx_data[4] = 0x0b;
    bqb_info->tx_data[5] = 0x09;
    bqb_info->tx_data[6] = 'L';
    bqb_info->tx_data[7] = 'a';
    bqb_info->tx_data[8] = 'r';
    bqb_info->tx_data[9] = 'k';
    bqb_info->tx_data[10] = '_';
    bqb_info->tx_data[11] = 'B';
    bqb_info->tx_data[12] = 'Q';
    bqb_info->tx_data[13] = 'B';
    bqb_info->tx_data[14] = 0x00;
    bqb_info->tx_data[15] = 0x00;
    btdrv_send(HCI_CMD, bqb_info->tx_data, 16);  /* HCI set name */
    k_sleep(K_MSEC(20));
#endif
...
int bqb_init(bool ble_bqb)
{
    ...
    bqb_info->ble_bqb_mode = ble_bqb ? 1 : 0;
