...
#define GPIOKEY_MFP_CFG (GPIO_CTL_SMIT | GPIO_CTL_PULLUP | GPIO_CTL_GPIO_INEN | GPIO_CTL_INTC_EN | GPIO_CTL_INC_TRIGGER_DUAL_EDGE)//(GPIO_CTL_SMIT | GPIO_INT_LEVEL | GPIO_PUD_PULL_UP | GPIO_DIR_IN | GPIO_INT_DEBOUNCE | GPIO_INT | GPIO_INT_EDGE|GPIO_INT_DOUBLE_EDGE)//
