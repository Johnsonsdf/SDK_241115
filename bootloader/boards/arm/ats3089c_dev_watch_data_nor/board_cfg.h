...
#define CONFIG_GPIO_ADFU						0
#define CONFIG_ADFU_KEY_GPIO					GPIO_21

#define CONFIG_TXRX_ADFU						0
#define CONFIG_ADFU_TX_GPIO						GPIO_28
#define CONFIG_ADFU_RX_GPIO						GPIO_29
...
#define CONFIG_SPI_FLASH_DELAY_CHAIN    (28)  //unit:0.25ns
#define CONFIG_SPI_FLASH_NO_IRQ_LOCK    1
#define CONFIG_SPI_FLASH_FREQ_MHZ    	70


#define CONFIG_SPI_FLASH_2_CHIP_SIZE      0x2000000
#define CONFIG_SPI_FLASH_2_BUS_WIDTH      4
#define CONFIG_SPI_FLASH_2_DELAY_CHAIN    (20)  //unit:0.5ns
#define CONFIG_SPI_FLASH_2_NO_IRQ_LOCK    1
#define CONFIG_SPI_FLASH_2_FREQ_MHZ    	96


#define CONFIG_SPI0_NOR_DTR_MODE
//#define CONFIG_SPI0_NOR_QPI_MODE
#define CONFIG_SPI_XIP_READ
#define  CONFIG_SPI_4X_READ
...
#define CONFIG_AUDIO_DAC_0_PCMBUF_HE_THRES      (0x1E0)

/* The threshold to generate half full IRQ signal. */
#define CONFIG_AUDIO_DAC_0_PCMBUF_HF_THRES      (0x1F0)
 ...
 *   - 1: slaver
 */
#define CONFIG_AUDIO_I2SRX_0_MODE               (1)
