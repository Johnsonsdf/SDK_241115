...
/* If 1 to enable spi0 use 2cs(2 chip norflash) , 
if enable, 
CONFIG_NOR_SUSPEND_RESUME=N (must N)
CONFIG_SPI0_NOR_QPI_MODE not define
*/
#define CONFIG_SPI_FLASH_GPIO_2CS    (1)
#if (CONFIG_SPI_FLASH_GPIO_2CS == 1)
#define CONFIG_SPI_FLASH_1_GPIO_CS_PIN    (64)
#endif
